...
namespace Адовые_коды__13__Практическая_намбер_тёртин_
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            odd = new StreamWriter(@"C:\users\ИСП-23\source\Repos\Адовые коды №13 (Практическая намбер тёртин)\odd.txt"); //Путь в никуда
            even = new StreamWriter(@"C:\Users\ИСП-23\source\Repos\Адовые коды №13 (Практическая намбер тёртин)\even.txt"); //Путь в куда
            do
            {
            ...
            odd1.Close();
            even1 = new StreamReader(@"C:\users\ИСП-23\source\Repos\Адовые коды №13 (Практическая работа тёртин)\odd.txt");
            for (i = 1; i <= koll; i++)
            {
